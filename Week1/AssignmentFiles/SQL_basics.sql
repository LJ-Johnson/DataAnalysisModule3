...
SELECT o.order_id, o.status, COUNT(*) AS total_items
FROM orders o
JOIN order_items oi ON o.order_id = oi.order_id
GROUP BY o.order_id, o.status;
-- Q8) Show orders placed on '2025-09-04' (any time that day).
select * from orders where order_datetime >= '2025-09-04' and order_datetime < '2025-09-05';
...
select concat (last_name, ',', first_name) as customer_name from customers group by last_name, first_name;
